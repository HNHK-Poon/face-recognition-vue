      ...
      <div class="relative mb-4">
        ...
        >
          <div
            class="w-50 h-20 p-8 text-slate-500 font-bold bg-white rounded-xl text-center justify-center items-center flex"
          >
            <img class="w-12 h-12 mr-4" src="@/assets/prohibition.png" />
            Access Denied
          </div>
        </div>
      </div>
  ...
  created() {
    ...
    this.socket.onmessage = function (event) {
      ...
      if (component.isGateOpen || component.isAccessDenied) {
        ...
        component.countUserNotDetected = 0;
        ...
        component.countUserNotDetected += 1;
        console.log(component.countUserNotDetected);
        if (component.countUserNotDetected > 3) {
          component.isAccessDenied = true;
          setTimeout(() => {
            component.isAccessDenied = false;
            component.countUserNotDetected = 0;
          }, 3000);
        }
      } else {
